import { addUser, shareWinner, loose, restartGame, joinGame, inGame, getAllRooms, getEndLine, sendMalus, createTableX, createTableY, disconnected, getCurrentPiece, createGame, getMorePiece, getNextPiece, move, startGameServer, initOtherTab, initOtherTabForVisitor, upScore } from '../src/client/actions/action'
'use strict'
...
describe('Front-end', () => {
    ...
    describe('Action', () => {
        ...
        it ('should be true when getEndLine action is test', done => {
            const lol = getEndLine([], 0, {username : "louis"})
            done()
        })
